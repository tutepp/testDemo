          ...
          <div class="container px-6 mx-auto grid">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalProduct" aria-hidden="true">
                <div class="modal-dialog">
                    ...
                    <form id="form-edit" data-url="{{route('products.store')}}" >
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="save_product()" class="btn btn-primary">Save changes</button>
                    </div>
                    </form>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                        <button type="button" onclick="create_product()" class="btn btn-primary">Save changes</button>
                    </div>
                    </form>
                    </div>
                </div>
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  @foreach ($products as $key => $product)
                    <tr class="text-gray-700 dark:text-gray-400">
                      ...
                      <td class="px-4 py-3 text-xs"><img src={{asset('public/image').'/'.$product->image }} alt="image"></td>
        ...
        function show_product(){
            ...
            console.log(url)
					$.ajax({
                        ...
                        $('#product_image_edit').val(response.data.image)
